...
/*         return ret; */
/*     } */
/*     //ERR_raisegc(ERR_LIB_EC, EC_R_OPERATION_NOT_SUPPORTED); */
/*     return 0; */
/* } */
...
{
	// TODO: see if needed, pretty sure no for verification
	return 1;
/*     int ok = 0; */
...
/*  */
/*     ok = 1; */
/* 	// TODO: figure out if useful, for now not including */
/*     #<{(| if (pairwise_test) { |)}># */
                              ...
                              unsigned char *buf, size_t len)
{
    ...
    if (BN_bn2binpad(eckey->priv_key, buf, buf_len) == -1) {
        //ERR_raisegc(ERR_LIB_EC, EC_R_BUFFER_TOO_SMALL);
        return 0;
    }
...
int ec_key_simple_oct2priv(EC_KEY *eckey, const unsigned char *buf, size_t len)
{
    ...
    if (eckey->priv_key == NULL) {
        //ERR_raisegc(ERR_LIB_EC, ERR_R_MALLOC_FAILURE);
        return 0;
    }
    eckey->priv_key = BN_bin2bn(buf, len, eckey->priv_key);
    if (eckey->priv_key == NULL) {
        //ERR_raisegc(ERR_LIB_EC, ERR_R_BN_LIB);
        return 0;
    }
    eckey->dirty_cnt++;
    return 1;
